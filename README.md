...
- **Irodori TTS:** Local inference in a dedicated Electron WebGPU renderer. WAV, MP3, M4A, AAC, OGG, FLAC, and WebM references are converted to 48 kHz WAV and copied into app-managed storage; multiple named reference voices are supported
