...
- キャラクターをクリックしたときの反応も、通常時は選択中のTTS、Realtime接続中はキャラクターごとのRealtime音声で読み上げ
